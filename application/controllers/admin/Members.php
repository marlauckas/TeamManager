...
class Members extends Admin_Controller {
	...
	public function __construct()
	{
		...
		/* Breadcrumbs :: Common */
		$this->breadcrumbs->unshift(1, lang('menu_members'), 'admin/members');
	}
...
//			}
	...
	{
		/* Breadcrumbs */
		$this->breadcrumbs->unshift(2, lang('menu_members_create'), 'admin/members/create');
		$this->data['breadcrumb'] = $this->breadcrumbs->show();
